...
@interface KinemeGLQuadPatch : QCPatch
{
	...
	QCNumberPort	*inputX4;
	QCNumberPort	*inputY4;
	QCNumberPort	*inputZ4;
	QCNumberPort	*inputU4;
	QCNumberPort	*inputV4;
	QCColorPort		*inputColor4;
